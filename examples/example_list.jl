...
_NAMES_TO_ACCEPTEDNAMES = Dict{Symbol,Array{Symbol}}(
    ...
    :JansenRitAux2 => [:jansenritaux2, :jansen_rit_aux2, :jansen_and_rit_aux2, :jansenandritaux2],
    :JansenRitAuxFull => [:jansenritauxfull, :jansen_rit_aux_full, :jansen_and_rit_aux_full, :jansenandritauxfull],
    :Lorenz => [:lorenz],
...
_NAMES_TO_PATH = Dict{Symbol, String}(
    ...
    :JansenRitAux2 => joinpath("jansen_and_rit","jansen_and_rit_aux_2.jl"),
    :JansenRitAuxFull => joinpath("jansen_and_rit","jansen_and_rit_aux_full_obs.jl"),
